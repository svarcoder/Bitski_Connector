...
export declare class FmProvider {
    ...
    /**
     * Support EIP-1193 Provider.request interface
     */
    request(payload: Partial<JsonRpcRequestPayload>): Promise<string[]>;
    /**
     * Support EIP-1193 Provider.on interface
     */
    on(msgType: string, callBack: any): () => void;
    /**
