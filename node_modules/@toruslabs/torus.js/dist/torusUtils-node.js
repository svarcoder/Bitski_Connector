...
const loglevel_log = external_loglevel_default().getLogger("torus.js");
loglevel_log.disableAll();
/* harmony default export */ const loglevel = (loglevel_log);
...
const keyAssign = async _ref => {
  ...
  try {
    ...
    return await post(endpoints[nodeNum], utils_objectSpread(utils_objectSpread({}, data), signedData), {
      headers: {
        "Content-Type": "application/json; charset=utf-8"
      }
    });
