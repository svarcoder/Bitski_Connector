...
declare class Torus {
    ...
    init({ buildEnv, enableLogging, enabledVerifiers, network, loginConfig, showTorusButton, integrity, whiteLabel, skipTKey, useWalletConnect, mfaLevel, }?: TorusParams): Promise<void>;
